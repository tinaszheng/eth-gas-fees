...
export const GAS_LIMIT_INFLATION_FACTOR = BigNumber.from(1.2 * 100).div(100)// For padding gas estimations to increase likelyhood of success. 1 == no inflation.
export const GAS_FAST_MULTIPLIER = BigNumber.from(1.25 * 100).div(100) // Gas price factor to raise urgency to fast
export const GAS_URGENT_MULTIPLIER = BigNumber.from(1.5 * 100).div(100) // Gas price factor to raise urgency to urgent
